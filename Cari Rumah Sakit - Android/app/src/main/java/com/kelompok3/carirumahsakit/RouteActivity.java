        ...
        LocationListener
{
    ...
    private void getMarkers(final int routeNo) {
        ...
        String url = "https://bangryan.website/carirumahsakit/index.php?from="+lastLat+","+lastLng+"&target="+query;
    ...
    private String getDirectionsUrl() {
        String googleApiKey = "AIzaSyABWDQNhkTtFM0A5Kb8srOUg88PqBFWR1o";
