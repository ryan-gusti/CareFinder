...
import com.kelompok3.carirumahsakit.app.AppController;
        ...
        LocationListener
{
    ...
    private double lastLat = -6.2964695;
    private double lastLng = 107.3101353;
    ...
    private void getMarkers() {
        String url = "https://bangryan.website/carirumahsakit/index.php?from="+lastLat+","+lastLng;
                    ...
                    if(tmpRadius > 2147483647){
                        ...
                        if(getAreaDone > 0){
                            if(getAreaDone == maxArea){
                                Toast.makeText(ListActivity.this, "Ditemukan "+String.valueOf(getAreaDone)+" Rumah Sakit terdekat (MAX "+maxArea+" lokasi)",
                                        Toast.LENGTH_LONG).show();
                            }else{
                                Toast.makeText(ListActivity.this, "Ditemukan "+String.valueOf(getAreaDone)+" Rumah Sakit terdekat", Toast.LENGTH_LONG).show();
                            }
                            ...
                            Toast.makeText(ListActivity.this, "Rumah Sakit tidak ditemukan dalam radius ("+String.valueOf(lengthRadius)+" m), silahkan ubah nilai Radius",
                                    Toast.LENGTH_LONG).show();
                        }
                    }
    ...
    private void addMarker(double mark_lat, double mark_lng, final String title) {
        ...
        if(results[0] <= lengthRadius){
            ...
            vPlaces.add(title.substring(0)+" ("+String.format("%.2f", results[0])+"m)");
